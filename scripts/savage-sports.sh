#!/bin/bash
# Savage Sports Daily - Fetch m3u and post to Telegram
# Simple parsing approach

M3U_URL="https://opop.pro/qXxCduZYsHQ2"
...
# Build message
MESSAGE="🏆 Savage Sports Today%0A%0A"

# Parse each line: extract category|name pairs
# Format: group-title="CATEGORY" tvg-name="NAME"
...
while IFS='|' read -r category name; do
    ...
    # Skip empty entries (like "MLB 01:" with no info after colon)
...
echo "Savage Sports posted at $(date)"
