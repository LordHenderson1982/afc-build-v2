...
function showMainMenu($chatId, $botToken) {
    $text = "📚 *How can I help?*\n\n" .
        "Select an option below or just ask me!";
    ...
    $keyboard = array(
        ...
        array(
            ...
            array('text' => '📱 Android', 'callback_data' => 'cat_android')
        ),
        array(
            array('text' => '🔮 Portal', 'callback_data' => 'cat_portal'),
            array('text' => '🔗 Link Telegram', 'callback_data' => 'cat_link_telegram')
        ),
        array(
            array('text' => '🛑 Buffering', 'callback_data' => 'cat_buffering'),
            array('text' => '📡 Channels', 'callback_data' => 'cat_channels')
        ),
        array(
            array('text' => '🔄 Renew', 'callback_data' => 'cat_renew'),
            array('text' => '🔐 Login', 'callback_data' => 'cat_login')
        ),
        array(
            array('text' => '📞 Support', 'callback_data' => 'cat_support')
        )
    );
